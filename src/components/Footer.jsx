              ...
              <form onSubmit={(e) => e.preventDefault()}>
                <div className="flex">
                  <input
                    ...
                    className="flex-grow bg-bg border border-border rounded-l-lg px-3 py-2 text-text placeholder-muted focus:outline-none focus:ring-2 focus:ring-accent focus:border-transparent"
                  />
                  <button type="submit" className="bg-accent text-bg px-4 py-2 font-bold rounded-r-lg transition-opacity hover:bg-opacity-80">
                    →
                  </button>
                </div>
              </form>
